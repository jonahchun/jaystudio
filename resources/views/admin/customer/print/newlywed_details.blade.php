...
@section('content')
    ...
    <div class="row mt-3">
      <div class="col-6">
        <form>
          <div class="form-group">
            <h6 class="m-0 pb-1">Wedding Planner:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Venue:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div>
          <div class="form-group">
            <h6 class="m-0 pb-1">Catering:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Stationary:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">DJ:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div>
          <div class="form-group">
            <h6 class="m-0 pb-1">Band:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Limousine:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Flowers:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div>
          <div class="form-group">
            <h6 class="m-0 pb-1">Cake:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div>  
        </form>
      ...
      <div class="col-6">
        <form>
          <div class="form-group">
            <h6 class="m-0 pb-1">Rings:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Makeup:</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
              ...
              <div class="col-6">
                <label for="exampleFormControlInput1">Salon (if applicable)</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
              </div>
            </div>                
          </div>
          <div class="form-group">
            <h6 class="m-0 pb-1">Hair:</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
          ...
          <div class="form-group">
            <h6 class="m-0 pb-1">Hair Accessories:</h6>
            <label for="exampleFormControlInput1">Name / Company</label>
            <input type="text" class="form-control" id="exampleFormControlInput1">
          </div> 
          <div class="form-group">
            <h6 class="m-0 pb-1">Bride’s Dress:</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
              ...
              <div class="col-6">
                <label for="exampleFormControlInput1">Purchased at (store)</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
              </div>
            </div>                
          </div>
          ...
          <div class="form-group">
            <h6 class="m-0 pb-1">Bridesmaid Dresses:</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
          ...
          <div class="form-group">
            <h6 class="m-0 pb-1">Groom’s Attire::</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
          ...
          <div class="form-group">
            <h6 class="m-0 pb-1">Groomsmen’s Attire:</h6>
            <div class="row">
              <div class="col-6">
                <label for="exampleFormControlInput1">Name / Company</label>
                <input type="text" class="form-control" id="exampleFormControlInput1">
