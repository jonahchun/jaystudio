...
@section('edit_request_title', __('Engagement Session - Edit Request'))
            ...
            <div class="info-column__item">
                ...
                @foreach($edit_request->detail as $data)
                    <p class="info-column__value">
                        {{ __('Image :image - :description', ['image' => optional($data)['image'], 'description' => optional($data)['description']]) }}
                    </p>
                @endforeach
                </div>
            </div>
