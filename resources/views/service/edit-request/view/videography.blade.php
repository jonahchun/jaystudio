...
@section('edit_request_title', __('Cinematography - Edit Request'))
            ...
            <div class="info-column__item">
                ...
                @foreach($edit_request->detail as $data)
                    <p class="info-column__value">
                        {{ __(':timestamp - :description', ['timestamp' => optional($data)['timestamp'], 'description' => optional($data)['description']]) }}
                    </p>
                @endforeach
                </div>
            </div>
