    ...
    >
        ...
        <div v-if="current_step < 2 || !current_step" class="schedule-forms">
            ...
            <div class="schedule-form__section full-width">
                ...
                <div class="form-select-wrap">
                    <Select2
                        v-model="getCurrentRelation().preparation_id"
            ...
            <div
                v-if="
                    (newlywed_types[0] == 'bride' && current_step == 0) ||
                        (newlywed_types[1] == 'bride' && current_step == 1)
                "
                class="schedule-form__section full-width"
            >
                <h3 class="schedule-form__title">
            ...
            <div class="schedule-form__section">
                ...
                Starting time of our Team will be determined during your phone
                meeting with our scheduling coordinator.
                <div class="mt-3"></div>
                <div class="datepicker-form">
                    ...
                    <div class="form-control-wrap">
                        <label
                            :for="getCurrentRelationName() + '_contact_name'"
                            :class="{
                                'form-control-label js-form-label': true,
                                active: getCurrentRelation().contact_name
                            }"
                        >
                            Full Name
                        </label>
                    ...
                    <div class="form-control-wrap">
                        <label
                            :for="getCurrentRelationName() + '_contact_phone'"
                            :class="{
                                'form-control-label js-form-label': true,
                                active: getCurrentRelation().contact_phone
                            }"
                        >
                            Phone
                        </label>
                ...
                <div class="form-select-wrap">
                    <Select2
                        v-model="getCurrentRelation().contact_id"
        ...
        <div v-if="current_step == 2" class="schedule-forms">
                ...
                <div class="schedule-form__section-inner">
                    <div class="form-control-wrap">
                        <label
                            class="schedule-form__title"
                            :for="
                                getCurrentRelationName() + '[name_of_ceremony]'
                            "
                            >Name of Ceremony Location:</label
                        >
                        <input
                            class="form-control"
                            type="text"
                            ...
                            "
                            :value="
                                getCurrentRelation().name_of_ceremony
                                    ? getCurrentRelation().name_of_ceremony
                                    : getCurrentRelation().address.name
                            "
                            required
                        />
                        <input
            ...
            <div class="schedule-form__section options">
                <div class="schedule-form__section-inner radio-group">
                    ...
                    <div
                        v-for="setting in this.ceremony_settings"
                    ...
                    >
                        ...
                        />
                        <label :for="`setting_` + setting.identifier">{{
                            setting.title
                        }}</label>
                    </div>
                    <div class="form-control-wrap other">
                        <input
                            ...
                            @change="
                                ceremony_settings_other = true;
                                getCurrentRelation().settings = '';
                            "
                            :name="getCurrentRelationName() + '[settings]'"
                        />
                ...
                <div class="schedule-form__section-inner radio-group">
                    ...
                    <div
                        v-for="tradition in this.ceremony_traditions"
                        :key="tradition.identifier"
                    >
                        <input
                            type="checkbox"
                            :name="
                        ...
                        />
                        <label :for="`tradition_` + tradition.identifier">{{
                            tradition.title
                        }}</label>
                    </div>
                    <div class="form-control-wrap other">
                        <input
                            type="checkbox"
                            id="tradition_other"
                            v-model="ceremony_traditions_other"
                        />
                    ...
                    <input
                        type="hidden"
                        v-if="showEmptyTraditionsInput()"
                        :name="
                            getCurrentRelationName() + '[ceremony_traditions]'
                        "
                        value=""
                    />
                    <input
                ...
                <div class="schedule-form__section-inner radio-group">
                    ...
                    <div
                        v-for="detail in this.ceremony_details"
                    ...
                    >
                        <input
                            ...
                            "
                            v-model="
                                getCurrentRelation().details[detail.identifier]
                            "
                            :value="detail.identifier"
                            :id="`detail_` + detail.identifier"
                        />
                        <label :for="`detail_` + detail.identifier">{{
                            detail.title
                        }}</label>
                    </div>
                    <div class="form-control-wrap other">
                        <input
                            ...
                            "
                            :name="
                                getCurrentRelationName() + '[details][other]'
                            "
                        />
        ...
        <div v-if="current_step == 3" class="schedule-forms">
            ...
            <div class="schedule-form__section">
                <div class="schedule-form__section-inner">
                    <label
                        class="schedule-form__title"
                        for="getCurrentRelationName() + '[name_of_reception]'"
                        >Name of Reception Location:</label
                    >
                    <input
                        class="form-control"
                        type="text"
                        ...
                        :value="
                            getCurrentRelation().name_of_reception
                                ? getCurrentRelation().name_of_reception
                                : getCurrentRelation().address.name
                        "
                        required
                ...
                <div class="schedule-form__section-inner">
                    <label
                        class="schedule-form__title"
                        for="getCurrentRelationName() + '[insurance_certificate]'"
                    ...
                    <div class="form-group">
                        <input
                            ...
                            :checked="
                                getCurrentRelation().insurance_certificate == 1
                            "
                            v-model="getCurrentRelation().insurance_certificate"
                            required
                        /><br />
                        <label for="insurance_certificate_y">Yes </label>
                        (Please email us at
                        <a
                            href="mailto:support@jaylimstudio.com"
                            style="font-weight:bold;color:rgba(57, 57, 57, 0.5);"
                            >support@jaylimstudio.com</a
                        >
                        if you need a Certificate of Insurance) **
                    </div>
                    <div class="form-group">
                        <input
                            type="radio"
                            ...
                            :checked="
                                getCurrentRelation().insurance_certificate == 0
                            "
                            v-model="getCurrentRelation().insurance_certificate"
                            required
                        />
                    ...
                    />
                    <a
                        :href="download_urls.download"
                        style="color:#fb434c;"
                        v-if="is_download_file == 1"
                        >Download Insurance Certificate</a
                    >
                </div>
                <div class="schedule-form__section-inner">
                    ...
                    <div class="address-form">
                        <div class="form-control-wrap js-input-wrap">
                            ...
                            <input
                                ...
                                "
                                :value="
                                    getCurrentRelation().venue_coordinator_name
                                "
                                required
                            />
                            <input
                        ...
                        <div class="form-control-wrap js-input-wrap">
                            ...
                            <input
                                ...
                                "
                                :value="
                                    getCurrentRelation().venue_coordinator_email
                                "
                                required
                            />
                            <input
                        ...
                        <div class="form-control-wrap js-input-wrap">
                            ...
                            <input
                                ...
                                "
                                :value="
                                    getCurrentRelation().venue_coordinator_phone
                                "
                                required
                            />
                            <input
            ...
            <div class="schedule-form__section flex">
                ...
                <div class="form-control-wrap js-input-wrap full-width">
                    <label
                        :class="{
                            'form-control-label js-form-label': true,
                            active: getCurrentRelation().toast_givers
                        }"
            ...
            <div class="details-forms">
                <p class="details-forms__comment-description">
                    Please submit your reception timeline provided by the venue
                    or DJ.
                </p>
                <file-uploader
                    name="reception[timeline_file]"
                    :value="getCurrentRelation().timeline_file"
                ></file-uploader>
                <input
                    type="hidden"
                    :name="
        ...
        <div v-if="current_step == 4" class="schedule-forms">
            ...
            <div class="schedule-form__section full-width radio-group">
                <h3>
                    When is your portrait session (including bride & groom,
            ...
            <div class="schedule-form__section full-width flex">
                <h3 class="schedule-form__title">
                    Enter one or more portrait session locations:
                </h3>
                <div
                    class="schedule-form__section-inner"
                    v-for="(address, index) in this.schedule.portrait_session
                        .portrait_session_locations"
                    :key="index"
                >
                    <b
                        v-html="'Location ' + (index + 1)"
                        class="schedule-form__title"
                    ></b>
                    <br />
                    <repeater-address
                ...
                <div class="schedule-form__action-add">
                    ...
                    <p class="btn-note">
                        Please click "Next" if you are unsure
                    </p>
                </div>
            </div>
            <div class="schedule-form__action mb-4" v-if="!readonly">
        ...
        <div v-if="current_step == 5" class="schedule-forms">
            ...
            <p class="h3 mb-4">
                ...
                availabilities to connect to our scheduling coordinator to
                confirm your wedding details: (This meeting will take about
                10-15 minutes)
            </p>
            ...
            <div class="details-forms">
                <div class="details-forms__comment">
                    ...
                    >
                    <p class="details-forms__comment-description">
                        Feel free to list any specific wedding day details you’d
                        like for our Team to know ahead of time. Also, please
                        make sure to let us know of any chances that may occur
                        prior to, or on the day of your special day.
                    </p>
                    <textarea
                        :name="'comment'"
                        :value="comment"
                ...
                <p class="details-forms__comment-description">
                    Please attach files if you would like to share planner
                    timeline, notes, etc.
                </p>
                <file-uploader
                    name="file"
...
export default {
    ...
    data() {
        ...
        for (var index in this.ceremony_settings) {
            if (
                schedule.ceremony.settings &&
                this.ceremony_settings[index].title ==
                    schedule.ceremony.settings
            ) {
                ceremony_settings_other = false;
                schedule.ceremony.settings = this.ceremony_settings[
                    index
                ].identifier;
            }
        }

        var preparation_settings_other = schedule.preparation.settings
            ? true
            : false;
        ...
        for (var index in this.preparation_settings) {
            ...
            if (
                schedule.preparation.settings &&
                this.preparation_settings[index].identifier ==
                    schedule.preparation.settings
            ) {
                ceremony_settings_other = false;
            }
        ...
        var ceremony_details_other =
            typeof schedule.ceremony.details.other != "undefined"
                ? true
                : false;
        ...
        for (var index in this.contacts) {
            contacts_settings_select.push({
                ...
                text:
                    this.contacts[index].first_name +
                    " " +
                    this.contacts[index].last_name +
                    (this.contacts[index].role_id
                        ? " (" + this.contacts[index].role.title + ")"
                        : "")
            });
        }
        ...
        return {
            ...
            current_step: !this.readonly
                ? this.wedding_schedule.current_step
                : 0,
            ...
            schedule: schedule,
            is_final_step: 0,
            ceremony_traditions_other: !!schedule.ceremony.ceremony_traditions[
                "other"
            ],
    ...
    mounted() {
        this.schedule.portrait_session.when = JSON.parse(
            this.schedule.portrait_session.when
        );
    ...
    methods: {
        ...
        addItems() {
            this.schedule.portrait_session.portrait_session_locations.push({
                portrait_start_time: "00.00",
                portrait_end_time: "00.00",
                address: {
                    address_line_1: "",
                    address_line_2: "",
                    country: "",
        ...
        removeItem(index) {
            this.schedule.portrait_session.portrait_session_locations.splice(
                index,
                1
            );
        },
