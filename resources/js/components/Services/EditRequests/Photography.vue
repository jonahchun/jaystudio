...
<div>
    <form :action="form_action" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <section v-show="currentStep == 0" class="b-request">
            <div class="b-request__heading mb-0 row">
                <div class="col-3"><h3 class="b-request__ttl">Photo Image Number</h3></div>
                <div class="col-9"><h3>Description of Edits</h3></div>
            </div>
            <span class="b-request__ttl-note mb-4">{{ note }}</span>

            <div v-for="row in rowsCount" class="row js-request-row">
                <div class="col-3">
                    <div class="form-control-wrap">
                        <input class="form-control" :name="'detail[' + row + '][image]'" type="text" />
                    </div>
                </div>
